...
Public Class Frm_Actualizacion_Rep
    ...
    Private Sub Cbx_Estado_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Cbx_Estado.SelectedIndexChanged
        ...
        Btn_Grabar_Actua.Visible = False
        Txt_Adicional.Text = ""
        Txt_Comentario.Text = ""
    End Sub
    ...
    Private Sub ACTUAREP()
        ...
        If factu_exist(Txt_Factura_Num.Text) = True Then
            Try
                ...
                Txt_Adicional.Visible = False
                Txt_Adicional.Text = ""
                Me.Size = New System.Drawing.Size(1289, 428)
                Btn_Grabar_Actua.Location = New Point(1188, 358)
            Catch ex As Exception
                MsgBox(ex.ToString)
            End Try
        Else
    ...
    Private Sub Txt_Adicional_TextChanged(sender As Object, e As EventArgs) Handles Txt_Adicional.TextChanged
        Btn_Grabar_Actua.Visible = True
        Btn_Grabar_Actua.Enabled = True
    End Sub
