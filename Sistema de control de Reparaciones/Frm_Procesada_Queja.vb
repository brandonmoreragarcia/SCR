...
Public Class Frm_Procesada_Queja
    Private Sub Frm_Procesada_Queja_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Btn_Guardar_Click(sender As Object, e As EventArgs) Handles Btn_Guardar.Click
        ...
        Try
            If Txt_Comentario.Text IsNot "" Then
                ...
                Dim sql As String = "insert into dbo.SCR_QUEJA_PROCESADA values(@NUMERO_QUEJA,@SOLUCION,@USUARIO,@FECHA_HORA,@ALISTO,@CHEQUEO)"
                ...
                cmd.Parameters.Add("@NUMERO_QUEJA", SqlDbType.Int).Value = Num_Queja
                cmd.Parameters.Add("@SOLUCION", SqlDbType.NVarChar).Value = Txt_Comentario.Text
                ...
                cmd.ExecuteNonQuery()
                cxnc.Close()
                cmd2.Parameters.Add("@NUMERO_QUEJA", SqlDbType.Int).Value = Num_Queja
                cmd2.Parameters.Add("@ESTADO", SqlDbType.NVarChar).Value = "PROCESADA"
            ...
            Else
                Throw New MyException("Error, el espacio 'Comentario' no puede ir en blanco")
            End If
    ...
    Private Sub Frm_Procesada_Queja_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
