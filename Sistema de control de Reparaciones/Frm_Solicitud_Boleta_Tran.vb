Public Class Frm_Solicitud_Boleta_Tran
    Dim solicitud As Boolean

    Private Sub Frm_Solicitud_Boleta_Tran_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        My.Forms.Frm_Main_Menu.Btn_Transporte.Enabled = False
        Num_Boleta = 0
    End Sub
